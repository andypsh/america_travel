...
const BOOKING = {
  ...
  now: [
    { id: 'yos', hotel: '✅ Yosemite 1박2일 투어 (마이리얼트립)', tag: 'YOS', nights: 1, dates: '6/29 → 6/30', priority: 1,
      action: '예약 완료', site: '마이리얼트립 · 요셈투어', note: '⭐ 730,000원/인 · 3인 = 2,190,000원 · SF 픽업/드롭 + Curry Village 숙박 + 가이드 + 저녁 BBQ + 아침 포함 (렌트카·입장료·예약 모두 불필요)',
      picked: 'MyRealTrip Yosem 1박2일 투어',
      candidates: [
        { name: '🎒 마이리얼트립 1박2일 투어 (확정)', stars: 5, perNight: 730000, total: 2190000, note: '✅ 예약 완료 · 인당 730,000원 · 3인 총 2,190,000원 · 픽업·숙박·가이드·식사 일체 포함', picked: true },
        { name: '커리 빌리지 직접 예약 (참고)',      stars: 2.5, perNight: 516491, total: 516491, note: '📌 DIY 대안 · 1실 1박 + 렌트카·주유·입장료 별도 (~$120 추가)' },
      ],
    },
    { id: 'sf-base', hotel: '✅ Hyatt Regency SF (Embarcadero) — 예약 확정', tag: 'SF', nights: 3, dates: '6/26 → 6/29', priority: 2,
      action: '예약 완료', site: '오투어 · 5 Embarcadero Center', note: '4★ · BART Embarcadero 역 직결 · 정가 1,200,000원 → CJ 콘도지원 후 실부담 인당 ~212k원 (한국 결제 149k + 현지 fees $46)',
      picked: 'Hyatt Regency San Francisco (Embarcadero)',
      candidates: [
        { name: 'Hyatt Regency SF (Embarcadero)', stars: 4, perNight: 400000, total: 1200000, actualPerPerson: 212000, note: '✅ 예약 확정 · 정가 인당 400k → CJ 콘도지원 후 실부담 인당 ~212k · BART 직결 · Bay Bridge view', picked: true },
    ...
    { id: 'lv', hotel: '✅ Caesars Palace — Octavius Pool View Room (예약 확정)', tag: 'LV', nights: 3, dates: '7/1 → 7/4', priority: 3,
      action: '예약 완료', site: '오투어 · 3570 Las Vegas Blvd S', note: '4.5★ · Octavius Tower (2012 신축) · Pool View · 2 Queen Beds + Rollaway · Strip 정중앙 · 분수쇼 도보 3분 · Topgolf 도보 5분 · OMNIA·Venus Pool·Forum Shops 직결',
      picked: 'Caesars Palace',
      candidates: [
        { name: 'Caesars Palace — Octavius Pool View, 2 Queens', stars: 4.5, perNight: 280399, total: 841196, note: '✅ 예약 확정 · Octavius 신관(2012) · Pool View · 무료취소 ~6/25 16시 · OMNIA·Venus Pool 직속', picked: true },
        { name: '패리스 라스베이거스',           stars: 4,   perNight: 341994, total: 1025982, note: '분수쇼 정면 (검토 대상)' },
        { name: '만달레이 베이',                stars: 4.5, perNight: 365673, total: 1097019, note: 'South Strip 풀장 1위 (검토 대상)' },
        { name: 'ARIA',                        stars: 5,   perNight: 518182, total: 1554546, note: '5★ 모던 럭셔리 (검토 대상)' },
        { name: '벨라지오',                    stars: 5,   perNight: 706976, total: 2120928, note: '5★ 럭셔리 (검토 대상)' },
      ],
    },
  ],
  standby: [
...
const POIS = {
  ...
  LV: [
    { kind: 'lodging',  name: '✅ Caesars Palace',            lat: 36.1163, lng: -115.1748, icon: '🏨', day: '7/1~7/4',
      booking: 'now', bookingPlan: 'AB', bookingNights: '3박 · ✅ 예약 확정',
      detail: '4.5★ · 3570 Las Vegas Blvd S · Octavius Tower (2012 신축) · Pool View Room · 2 Queen Beds + Rollaway · Strip 정중앙 · OMNIA·Venus Pool·Forum Shops 직속 · 분수쇼 도보 3분 · Topgolf 도보 5분',
      picked: true },
