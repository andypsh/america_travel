...
const transportRoutes = {
  SF: [
    { from: 'SFO 공항', to: 'Hyatt Regency Embarcadero (Union Square)', distance: '13mi · 21km', icon: '✈️',
      options: [
    ...
    { from: 'Hyatt Regency Embarcadero', to: 'Pier 33 (Alcatraz Cruises)', distance: '1.5mi · 2.5km', icon: '⛴',
      options: [
