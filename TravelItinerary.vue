...
const costData = {
  a: {
    ...
    hotel: [
      ...
      { name: 'YOS 1박2일 투어 (요셈투어·마이리얼트립 선납 완료)', detail: '마이리얼트립 결제분 778,770원/인 · 서비스 $50 + 비거주자 $100 + 점심은 현지 별도 지불 (정산 제외)', perPerson: 778770 },
    ...
    flight: [
      ...
      { name: 'LAS → SFO (Southwest 직항)', detail: '7/4 · 20:40 LAS → 22:15 SFO (1h 35m) · ⚠️ OZ211까지 1h 35분 빡빡', perPerson: 215752 },
    ],
    ticket: [
  ...
  b: {
    ...
    flight: [
      ...
      { name: 'SFO ↔ LAS 왕복 (Frontier 7/1 + Southwest 7/4 직항)', detail: '7/1 22:58→00:44 SFO→LAS (Frontier) / 7/4 20:40→22:15 LAS→SFO (Southwest) · ⚠️ 7/4 OZ211 23:50까지 1h 35분 빡빡', perPerson: 431503 },
    ],
    ticket: [
...
const aDays = [
  ...
  { date: '7/4 토', city: '라스베이거스 → SFO 귀국', cityTag: 'LV→SFO', icon: '🏠',
    note: '🚨 OZ211 23:50 SFO 출발과 LAS→SFO 22:15 도착 사이 1h 35분만 여유 · 체크인 마감 22:50 (60분 전) — 짐 픽업·AirTrain 이동·카운터 도착 빠르게',
    items: [
      ...
      { time: '15:30', text: '🍔 LV 마지막 점심 (Caesars 내 또는 Strip 인근)' },
      { time: '17:30', text: '🚖 Caesars → LAS 공항 (Uber 20분 · 7/4 혼잡 ⚠️ 여유 3h)' },
      { time: '20:40', text: '✈️ LAS → SFO (Southwest 직항 · 1h 35m · ₩431,503 왕복 분담)', bold: true },
      { time: '22:15', text: '🛬 SFO 도착 (Southwest Terminal 2) · 짐 픽업 빨리', bold: true },
      { time: '22:35', text: '🚇 AirTrain → International Terminal G (~15분) · 짐 들고 뛰기', bold: true },
      { time: '22:50~23:00', text: '🚨 아시아나 카운터 도착 · 체크인 마감 시각(22:50) 임박', bold: true },
      { time: '23:00~23:20', text: '🛂 보안검사 + 게이트 이동 (시간 매우 빠듯)', bold: true },
...
const laDays = [
  ...
  { date: '7/1 수', city: '실리콘밸리 → 라스베이거스', cityTag: 'SV→LV', icon: '💻', items: [
    ...
    { time: '저녁', text: '🍣 Ferry Building 마지막 SF 저녁 (Slanted Door·Hog Island) · The Strip 야경 즐길 LV 도착이 늦어서 SF에서 충분히 식사' },
    { time: '21:00', text: '🚇 Hyatt → Embarcadero BART → SFO (BART 직결, 약 35분, $10.85/인 · 일요일 막차 23:55 여유)' },
    { time: '22:58', text: '✈️ SFO → LAS (Frontier 직항 1h 46m · 왕복 ₩431,503 분담)', bold: true },
    { time: '00:44 (+1)', text: '🛬 라스베이거스 도착 (자정 넘김) · Uber로 Caesars Palace 심야 체크인 (24h 프런트)', bold: true },
    { time: '01:30~', text: '🌃 The Strip 야경 (자정 후에도 풍성) · 빠르게 잠 · 내일 11시 SpeedVegas 대비 ⚠️' },
  ]},
  { date: '7/2 목', city: '라스베이거스 · 🏎 SpeedVegas', cityTag: 'LV', icon: '🏎', items: [
  ...
  { date: '7/4 토', city: '라스베이거스 → SFO 귀국', cityTag: 'LV→SFO', icon: '🏠',
    note: '🚨 OZ211 23:50 SFO 출발과 LAS→SFO 22:15 도착 사이 1h 35분만 여유 · 체크인 마감 시각 22:50 (60분 전) — 짐 픽업·AirTrain 이동·카운터 도착이 동시에 빠르게 진행돼야 함',
    items: [
      { time: '오전', text: '😴 늦잠 · Caesars 풀장 (Garden of the Gods 어덜트 풀) · 브런치 (4일간 강행 회복)' },
      { time: '11:00', text: '🏨 체크아웃 · 짐 호텔 보관' },
      { time: '오후', text: '🛍 Forum Shops 마지막 쇼핑 · 🎰 마지막 카지노 (보수적) · 💦 Bellagio 분수쇼' },
      { time: '15:30', text: '🍔 LV 마지막 점심 (Caesars 내 또는 Strip 인근)' },
      { time: '17:30', text: '🚖 Caesars → LAS 공항 (Uber 20분 · 7/4 독립기념일 혼잡 ⚠️ 여유 3h)' },
      { time: '20:40', text: '✈️ LAS → SFO (Southwest 직항 · 1h 35m · ₩431,503 왕복 분담)', bold: true },
      { time: '22:15', text: '🛬 SFO 도착 (Southwest Terminal 2) · 짐 픽업 빨리 (대기 10~15분)', bold: true },
      { time: '22:35', text: '🚇 AirTrain → International Terminal G (~15분) · 짐 들고 뛰기', bold: true },
      { time: '22:50~23:00', text: '🚨 아시아나 카운터 도착 · 체크인 마감 시각(22:50) 임박 — 마감 후라도 카운터 직원에게 사정 설명 시도', bold: true },
      { time: '23:00~23:20', text: '🛂 보안검사 + 게이트 이동 (시간 매우 빠듯)', bold: true },
      { time: '23:50', text: '✈️ OZ211 SFO 출발 → 인천 7/6(일) 05:45 도착', bold: true },
  ]},
]
