...
const aDays = [
  ...
  { date: '7/3 금', city: '라스베이거스 · 서커스서커스', cityTag: 'LV', icon: '🎪', items: [
    { time: '오전', text: '😴 늦잠 · Caesars 풀장 (Garden of the Gods) · 브런치 (내일 SpeedVegas 컨디션 조절)' },
  ...
  { date: '7/4 토', city: '🏎 SpeedVegas → 라스베이거스 → SFO 귀국', cityTag: 'LV→SFO', icon: '🏁',
    note: '⚠️ 미국 독립기념일 — 공항 혼잡 · SpeedVegas 끝나면 바로 체크아웃 → LAS',
    items: [
      { time: '09:00', text: '🍳 Caesars 조식 · 짐 정리 · 체크아웃 짐 보관' },
      ...
      { time: '~14:00', text: '🚖 Uber → Caesars Palace 복귀 · 짐 픽업 (~14:30)' },
      { time: '15:00', text: '🚖 Caesars → LAS 공항 (Uber 20분 · 7/4 혼잡 ⚠️ 여유 있게)' },
      { time: '~17:00', text: '✈️ LAS → SFO 국내선 (약 1시간 20분)' },
...
const laDays = [
  ...
  { date: '7/4 토', city: '🏎 SpeedVegas → 라스베이거스 → SFO 귀국', cityTag: 'LV→SFO', icon: '🏁',
    ...
    items: [
      { time: '09:00', text: '🍳 Caesars 조식 · 짐 정리 · 체크아웃 짐 보관' },
      { time: '09:30~', text: '🚖 Uber → SpeedVegas (Sloan, NV · Strip 남쪽 20분 · $25~35)' },
      { time: '11:00', text: '✅ 🏎 SpeedVegas — Ferrari 488 GTB 7랩 (박성혁) · $475 + HD 영상·사진 $79 + 차량 손상 보호 $49 = $603 · Ref C0616037', bold: true },
      { time: '13:00', text: '✅ 🏁 Go Kart (VSK · 같은 부지) — Sodikart RT10 1레이스 · $35 · Ref C0616037', bold: true },
      { time: '~14:00', text: '🚖 Uber → Caesars Palace 복귀 · 짐 픽업' },
      { time: '15:00', text: '🚖 Caesars → LAS 공항 (Uber 20분 · 7/4 혼잡 ⚠️)' },
      { time: '~17:00', text: '✈️ LAS → SFO 국내선 (약 1시간 20분)' },
