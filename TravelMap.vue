...
const planA = {
  ...
  legs: [
    ...
    { city: 'SF',  date: '6/30 화', label: '요세미티 → SF 귀환',            icon: '🚙', desc: 'Glacier Point · 하이킹 · SF 1박' },
    { city: 'SEA', date: '7/1 수',  label: '🇰🇷 SF→SEA 새벽 비행 + Lumen + LV', icon: '⚽', desc: '04:30 기상 · 06:30 SFO→SEA · 13:00 Lumen Match 82 · 저녁 SEA→LAS', highlight: true },
