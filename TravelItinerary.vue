...
const costData = {
  a: {
    ...
    flight: [
      ...
      { name: '✅ LAS → SFO (Southwest 직항)', detail: '7/4 · 17:50 LAS → 19:30 SFO (1h 40m) · ⭐ OZ211까지 4h 20분 여유', perPerson: 222932 },
    ],
    ticket: [
...
const aDays = [
  ...
  { date: '7/4 토', city: '라스베이거스 → SFO 귀국', cityTag: 'LV→SFO', icon: '🏠',
    note: '✅ 17:50 LAS→SFO 안전 환승편 확정 · OZ211까지 4h 20분 여유',
    items: [
      { time: '오전', text: '😴 늦잠 · Caesars 풀장 (Garden of the Gods 어덜트 풀) · 브런치 (마지막 LV)' },
      { time: '11:00', text: '🏨 체크아웃 · 짐 호텔 보관' },
      { time: '12:00~14:30', text: '🛍 Forum Shops 마지막 쇼핑 · 🎰 마지막 카지노 (보수적) · 💦 Bellagio 분수쇼 · 점심' },
      { time: '15:00', text: '🚖 Caesars → LAS 공항 (Uber 20분 · 7/4 독립기념일 혼잡 ⚠️ 여유 2~3h)' },
      ...
      { time: '20:30', text: '🛂 아시아나 카운터 체크인 (마감 22:50 · 충분한 여유)', bold: true },
...
const laDays = [
  ...
  { date: '7/1 수', city: '실리콘밸리 → 라스베이거스', cityTag: 'SV→LV', icon: '💻', items: [
    ...
    { time: '22:58', text: '✅ ✈️ SFO → LAS (Frontier 직항 1h 46m · 왕복 ₩445,864 분담)', bold: true },
